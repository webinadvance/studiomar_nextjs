...
namespace Codaxy.WkHtmlToPdf
{
    ...
    public class PdfConvert
    {
        ...
        public static void ConvertHtmlToPdf(PdfDocument document,
                                            PdfOutput   output)
        {
            ...
            try
            {
                ...
                using (var process = new Process())
                {
                    ...
                    using (var outputWaitHandle = new AutoResetEvent(false))
                    {
                        ...
                        {
                            DataReceivedEventHandler outputHandler = (sender,
                                                                      e) =>
                            {
                                if (e.Data == null)
                                {
                            ...
                            DataReceivedEventHandler errorHandler = (sender,
                                                                     e) =>
                            {
                                if (e.Data == null)
                                {
        ...
        public static void ConvertHtmlToPdf(string url,
