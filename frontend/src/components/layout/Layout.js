...
function Layout({ children }) {
    ...
    const drawerContent = (_jsxs(Box, { sx: { height: '100%', display: 'flex', flexDirection: 'column' }, children: [_jsxs(Box, { sx: {
                    ...
                    }, children: [_jsx(Typography, { variant: "caption", sx: { color: 'rgba(255,255,255,0.6)', display: 'block', mb: 1 }, children: "Need Help?" }), _jsx(Typography, { variant: "body2", sx: { color: 'white', fontWeight: 500 }, children: "Contact Support" })] }) })] }));
    return (_jsxs(Box, { sx: { display: 'flex', minHeight: '100vh', bgcolor: 'background.default' }, children: [_jsx(AppBar, { position: "fixed", elevation: 0, sx: {
                    ...
                    ml: { md: `${drawerWidth}px` },
                }, children: _jsxs(Toolbar, { children: [_jsx(IconButton, { color: "inherit", "aria-label": "open drawer", edge: "start", onClick: handleDrawerToggle, sx: { mr: 2, display: { md: 'none' }, color: 'text.primary' }, children: _jsx(MenuIcon, {}) }), _jsxs(Box, { sx: { flexGrow: 1 }, children: [_jsx(Typography, { variant: "h6", color: "text.primary", fontWeight: "600", children: menuItems.find(i => i.path === location.pathname)?.text || 'Dashboard' }), _jsxs(Typography, { variant: "caption", color: "text.secondary", children: ["Welcome back, ", username] })] }), _jsxs(Box, { sx: { flexGrow: 0 }, children: [_jsx(Tooltip, { title: "Open settings", children: _jsx(IconButton, { onClick: handleOpenUserMenu, sx: { p: 0 }, children: _jsx(Avatar, { alt: username || "User", src: "/static/images/avatar/2.jpg", sx: { bgcolor: theme.palette.secondary.main }, children: username ? username.charAt(0).toUpperCase() : 'U' }) }) }), _jsxs(Menu, { sx: { mt: '45px' }, id: "menu-appbar", anchorEl: anchorElUser, anchorOrigin: {
                                        vertical: 'top',
                                        horizontal: 'right',
                                    ...
                                    }, children: [_jsxs(Box, { sx: { px: 2, py: 1.5 }, children: [_jsx(Typography, { variant: "subtitle2", noWrap: true, children: username }), _jsx(Typography, { variant: "body2", color: "text.secondary", noWrap: true, children: "user@example.com" })] }), _jsx(Divider, {}), _jsxs(MenuItem, { onClick: handleCloseUserMenu, children: [_jsx(ListItemIcon, { children: _jsx(PersonIcon, { fontSize: "small" }) }), _jsx(ListItemText, { children: "Profile" })] }), _jsxs(MenuItem, { onClick: handleLogout, sx: { color: 'error.main' }, children: [_jsx(ListItemIcon, { children: _jsx(LogoutIcon, { fontSize: "small", color: "error" }) }), _jsx(ListItemText, { children: "Logout" })] })] })] })] }) }), _jsxs(Box, { component: "nav", sx: { width: { md: drawerWidth }, flexShrink: { md: 0 } }, "aria-label": "mailbox folders", children: [_jsx(Drawer, { variant: "temporary", open: mobileOpen, onClose: handleDrawerToggle, ModalProps: { keepMounted: true }, sx: {
