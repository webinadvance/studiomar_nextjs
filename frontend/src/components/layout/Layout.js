...
function Layout({ children }) {
    ...
    return (_jsxs(Box, { sx: { display: 'flex', minHeight: '100vh', bgcolor: 'background.default' }, children: [_jsx(AppBar, { position: "fixed", elevation: 0, sx: {
                ...
                }, children: _jsxs(Toolbar, { children: [_jsx(IconButton, { color: "inherit", "aria-label": "open drawer", edge: "start", onClick: handleDrawerToggle, sx: { mr: 2, display: { md: 'none' }, color: 'text.primary' }, children: _jsx(MenuIcon, {}) }), _jsxs(Box, { sx: { flexGrow: 1 }, children: [_jsx(Typography, { variant: "h6", color: "text.primary", fontWeight: "600", children: menuItems.find(i => i.path === location.pathname)?.text || 'Dashboard' }), _jsxs(Typography, { variant: "caption", color: "text.secondary", children: ["Bentornato, ", username] })] }), _jsxs(Box, { sx: { flexGrow: 0 }, children: [_jsx(Tooltip, { title: "Open settings", children: _jsx(IconButton, { onClick: handleOpenUserMenu, sx: { p: 0 }, children: _jsx(Avatar, { alt: username || "User", src: "/static/images/avatar/2.jpg", sx: { bgcolor: theme.palette.secondary.main }, children: username ? username.charAt(0).toUpperCase() : 'U' }) }) }), _jsxs(Menu, { sx: { mt: '45px' }, id: "menu-appbar", anchorEl: anchorElUser, anchorOrigin: {
                                        vertical: 'top',
                                        horizontal: 'right',
