...
export default function ScadenzePage() {
    ...
    return (_jsxs(Box, { children: [_jsx(PageHeader, { title: "Scadenze", subtitle: "Manage upcoming deadlines and events.", action: _jsxs(_Fragment, { children: [_jsx(Button, { variant: "outlined", startIcon: _jsx(FileDownloadIcon, {}), onClick: handleExportPDF, disabled: exportMutation.isPending, children: exportMutation.isPending ? 'Esportazione...' : 'Esporta PDF' }), _jsx(Button, { variant: "contained", startIcon: _jsx(AddIcon, {}), onClick: handleCreate, children: "Nuova Scadenza" })] }) }), _jsx(Paper, { sx: { p: 3, mb: 4, borderRadius: 3 }, elevation: 0, children: _jsx(ScadenzeFilters, { onChange: setFilters }) }), _jsx(Paper, { sx: { p: 0, borderRadius: 3, overflow: 'hidden', border: '1px solid rgba(0,0,0,0.08)' }, elevation: 0, children: _jsx(ScadenzeList, { filters: filters, onEdit: handleEdit }) }), _jsx(ScadenzeForm, { open: formOpen, onClose: handleClose, scadenza: editingScadenza, isLoading: isScadenzaLoading })] }));
}
