...
export default function LoginPage() {
    ...
    return (_jsxs(Grid, { container: true, component: "main", sx: { height: '100vh' }, children: [_jsxs(Grid, { item: true, xs: false, sm: 4, md: 7, sx: {
                    ...
                    overflow: 'hidden'
                            ...
                            borderRadius: '50%',
                        } }), _jsxs(Box, { sx: { position: 'relative', zIndex: 1, maxWidth: 600, textAlign: 'center' }, children: [_jsxs(Typography, { variant: "h2", component: "h1", fontWeight: "700", sx: { mb: 2, letterSpacing: 1 }, children: ["STUDIO", _jsx("span", { style: { color: theme.palette.primary.light }, children: "MAR" })] }), _jsx(Typography, { variant: "h5", sx: { mb: 4, fontWeight: 300, opacity: 0.9 }, children: "Professional Management Suite" }), _jsx(Typography, { variant: "body1", sx: { opacity: 0.7, maxWidth: 480, mx: 'auto', lineHeight: 1.8 }, children: "Streamline your deadlines, manage clients efficiently, and access powerful insights with our next-generation platform." })] })] }), _jsx(Grid, { item: true, xs: 12, sm: 8, md: 5, component: Paper, elevation: 6, square: true, sx: {
                    display: 'flex',
                    flexDirection: 'column',
                    alignItems: 'center',
                    justifyContent: 'center',
                    bgcolor: 'background.default'
                        ...
                        maxWidth: 400
                                ...
                                boxShadow: theme.shadows[4]
                                        ...
                                        textTransform: 'none',
                                        boxShadow: theme.shadows[4]
                                    }, disabled: isLoading, children: isLoading ? 'Signing in...' : 'Sign In' }), _jsx(Grid, { container: true, justifyContent: "center", children: _jsx(Grid, { item: true, children: _jsx(Typography, { variant: "caption", color: "text.secondary", children: "Demo Access: admin / admin" }) }) })] })] }) })] }));
}
